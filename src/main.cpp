/***********************************************************************************
* ƒанный файл записывает изображение в формате P3, т.е. цвета даны в ASCII - 24 бита 
...
*
* ‘айл .ppm €вл€етс€ простым форматом хранени€ цветного изображени€. “акже может 
* быть использован в качестве промежуточного формата при конвертации растровых 
* изображений. 
* 
* ¬нутренне представление, по соглашени. r,g,b компонентов должно находитьс€ в 
* диапазоне [0;1].
* 
